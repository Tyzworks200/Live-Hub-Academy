...
export const TECH_DOCS = {
  ...
  quickSetupWizard: `${TECHDOCS_BASE}/Content/LiveHub/Configuration%20Wizard.htm`,
  ...
  routing: `${TECHDOCS_BASE}/Content/LiveHub/Managing%20Routing.htm`,
  ...
  callRecording: `${TECHDOCS_BASE}/Content/LiveHub/byoc_Call%20Recording.htm`,
  callTransfer: `${TECHDOCS_BASE}/Content/LiveHub/byoc_Call%20Transfer.htm`,
  statistics: `${TECHDOCS_BASE}/Content/LiveHub/Statistics.htm`,
  alarms: `${TECHDOCS_BASE}/Content/LiveHub/Vewing%20Alarms.htm`,
  billing: `${TECHDOCS_BASE}/Content/LiveHub/billing.htm`,
  userGroups: `${TECHDOCS_BASE}/Content/LiveHub/users-introduction.htm`,
  ...
  support: `${TECHDOCS_BASE}/Content/LiveHub/byoc_cloud_managing_help.htm`,
  releaseNotes: `${TECHDOCS_BASE}/Content/LiveHub/release-notes.htm`,
} as const;
